    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 z-50 flex items-center justify-center hover:scale-110 transition-transform group drop-shadow-[0_0_16px_hsl(var(--primary)/0.5)]"
